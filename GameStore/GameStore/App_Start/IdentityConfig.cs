...
namespace GameStore
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            client.Send("2016gamestore@gmail.com", message.Destination, message.Subject, message.Body);
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<GameStoreDbContext>()));
